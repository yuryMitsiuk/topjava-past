...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<MealWithExceed> getMealWithExceed(List<Meal> list, int caloriesPerDay) {
        return list.stream().map(meal -> createWithExceed(meal,
                list.stream().collect(Collectors.groupingBy(Meal::getDate, Collectors.summingInt(Meal::getCalories))).get(meal.getDate()) > caloriesPerDay)).collect(Collectors.toList());
    }
